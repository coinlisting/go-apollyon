...
// go-apollyon reward 600 CLO.
var (
	//go-apollyonBlockReward, _          = new(big.Int).SetString("600000000000000000000", 10) // Block reward in wei for successfully mining a block
...
func CalcDifficulty(config *params.ChainConfig, time uint64, parent *types.Header) *big.Int {
	...
	switch {
	//case config.Isgo-apollyon(next):
	//	return calcDifficultygo-apollyon(time, parent)
...
// InvokeAccumulateRewards calls accumulateRewards from Clique for go-apollyon.
