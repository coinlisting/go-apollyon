...
var (
	...
	APYMinerReward, _    = new(big.Int).SetString("3000000000000000000", 10)
	APYTreasuryReward, _ = new(big.Int).SetString("1000000000000000000", 10)
	...
	go-apollyonTestnetChainConfig = &ChainConfig{
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v go-apollyon: %v go-apollyon Treasury Address: %v Engine: %v}",
		c.ChainId,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
// go-apollyon has a 10x more cost in gas
